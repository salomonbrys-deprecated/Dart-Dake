...
class Assets implements DakeClosable {
    ...
    minify({    @Param(optAbbr: "b") bool build,
                @Param(optAbbr: "p") bool publish,
                @Param(optAbbr: "o", type: "file") String output,
                @Param(optAbbr: "c", type: "none|gzip|lzma", desc: "Compress the assets") String compression: "none"}) {
